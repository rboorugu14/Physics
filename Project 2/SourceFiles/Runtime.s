...
! =====================  GetCh  =====================
! 
! This is an implementation for GetCh where a user inputs one of the characters and it passes to the echoPrime script.
...
charOK2: 				!   endIf
		push     r2             !   Pushing only r2 as here we will be making the changes
		store   r2,[r15+4+4]   						
		pop      r2		!   Popping the registers back
		ret
